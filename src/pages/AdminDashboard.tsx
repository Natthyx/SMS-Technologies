                                    ...
                                    <tbody className="divide-y divide-white/10">
                                        {applications.map((application) => (
                                            <tr
                                                ...
                                                className={`cursor-pointer hover:bg-white/5 transition-colors ${selectedApplication?.id === application.id ? 'bg-white/10' : ''
                                                    }`}
                                            >
                            ...
                            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-lg border border-white/20 h-full">
                                <div className="p-6 border-b border-white/20">
                                    ...
                                    {selectedApplication.status && (
                                        <div className="mt-4">
                                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${selectedApplication.status === 'pending'
                                                    ? 'bg-yellow-100 text-yellow-800'
                                                                ...
                                                                {selectedApplication?.resumeData ? (
                                                                    <div className="border border-white/20 rounded-xl overflow-hidden bg-black">
                                                                        <iframe
                                                                            ...
                                                                            className="w-[100%] h-[calc(100vh-300px)]"
                                                                            onError={(e) => {
